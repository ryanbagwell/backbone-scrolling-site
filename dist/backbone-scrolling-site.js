...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(15), __webpack_require__(10), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
	...
	module.exports = SinglePageScrollingController = (function(superClass) {
	  ...
	  SinglePageScrollingController.prototype.initialize = function(options) {
	    ...
	    for (name in ref) {
	      ...
	      this.route(section.route, section.name, (function() {
	        var args;
	  ...
	  SinglePageScrollingController.prototype.navigate = function(route, options) {
	    ...
	    if (options.scroll) {
	      return this.scrollToSection(id);
	    }
	  };
