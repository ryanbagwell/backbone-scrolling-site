...
/***/ function(module, exports, __webpack_require__) {
	...
	var decap = __webpack_require__(19);
	...
	module.exports = SinglePageScrollingView = (function(superClass) {
	  ...
	  SinglePageScrollingView.prototype.initialize = function(options) {
	    ...
	    try {
	      ...
	      e = _error;
	      return console.warn("backbone-scrolling-site: Couldn't bind events to view named " + this.options.pageName);
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	s.capitalize       = __webpack_require__(18);
	s.decapitalize     = __webpack_require__(19);
	s.chop             = __webpack_require__(20);
	s.trim             = __webpack_require__(21);
	s.clean            = __webpack_require__(22);
	s.count            = __webpack_require__(23);
	s.chars            = __webpack_require__(24);
	s.swapCase         = __webpack_require__(25);
	s.escapeHTML       = __webpack_require__(26);
	s.unescapeHTML     = __webpack_require__(29);
	s.splice           = __webpack_require__(27);
	s.insert           = __webpack_require__(28);
	...
	s.endsWith         = __webpack_require__(37);
	...
	s.escapeRegExp     = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(75);
	var defaultToWhiteSpace = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(75);
	var escapeChars = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(75);
	var toPositive = __webpack_require__(80);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var adjacent = __webpack_require__(81);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = SinglePageScrollingController = (function(superClass) {
	  ...
	  SinglePageScrollingController.prototype.initialize = function(options) {
	    var method, name, params, ref, ref1, ref2, section;
	  ...
	  SinglePageScrollingController.prototype.loadSection = function(section, name, sections) {
	    ...
	    view = this.sections[name].instance = new section.view(opts);
	    return view.render();
	  };
	  ...
	  SinglePageScrollingController.prototype._getResolution = function() {
	    var bp, i, len, ref, ref1;
	    ref = this.resolutionBreakPoints;
	    for (i = 0, len = ref.length; i < len; i++) {
	      bp = ref[i];
	      if ((bp.min <= (ref1 = window.outerWidth) && ref1 <= bp.max)) {
	        return bp;
	      }
	    }
	  };
	  ...
	  SinglePageScrollingController.prototype.navigateOnScroll = function(e) {
	    ...
	    for (name in ref) {
	      section = ref[name];
	      console.log(name, this.inViewport(section.el));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(75);
	var strRepeat = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeRegExp = __webpack_require__(74);
