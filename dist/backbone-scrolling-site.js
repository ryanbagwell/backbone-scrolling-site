...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Backbone, MixedIn, Q, SinglePageScrollingView, _, mixins,
	...
	SinglePageScrollingView = (function(superClass) {
	  ...
	  SinglePageScrollingView.extend = function(obj) {
	    var key, ref, value;
	    for (key in obj) {
	      value = obj[key];
	      this[key] = value;
	  ...
	  SinglePageScrollingView.include = function(obj) {
	    var key, ref, value;
	    for (key in obj) {
	      value = obj[key];
	  ...
	  SinglePageScrollingView.prototype.initialize = function(options) {
	    ...
	    try {
	      ...
	      e = _error;
	      console.warn("backbone-scrolling-site: Couldn't bind events to view named " + this.options.pageName);
	    }
	    return Q.fcall((function(_this) {
	      return function() {
	        var deferred;
	        deferred = Q.defer();
	        _this.render(deferred.resolve);
	        return deferred;
	      };
	      ...
	      return function() {
	        var deferred;
	        deferred = Q.defer();
	        _this.afterRender(deferred.resolve);
	        return deferred;
	      };
	    })(this)).then((function(_this) {
	      return function() {
	        var deferred;
	        deferred = Q.defer();
	        _this.afterReady(deferred.resolve);
	        return deferred;
	      };
	    })(this)).then((function(_this) {
	      return function() {
	        var deferred;
	        deferred = Q.defer();
	        _this.cleanup(deferred.resolve);
	        return deferred;
	      };
	    })(this));
	  };
	
	  SinglePageScrollingView.prototype.render = function(done) {
	    this.rendered = true;
	    return done();
	  };
	
	  SinglePageScrollingView.prototype.afterRender = function(done) {
	    this.ready = true;
	    this.sendNotification("sectionReady", this.options.pageName);
	    return done();
	  };
	
	  SinglePageScrollingView.prototype.afterReady = function(done) {
	    return done();
	  };
	
	  SinglePageScrollingView.prototype.cleanup = function(done) {
	    this.off("rendered");
	    this.off("sectionReady");
	    return done();
	  };
	  ...
	  SinglePageScrollingView.prototype.getScrollToElement = function() {
	    return this.$el;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var capitalize, methods,
	  slice = [].slice;
	
	capitalize = __webpack_require__(9);
	...
	methods = {
	  ...
	  makeRouteFunction: function() {
	    return function() {
	      var args, name, section;
	      section = arguments[0], name = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
	      if (section.instance != null) {
	        section.instance.receiveNavigation.apply(section.instance, args);
	      }
	      this._logMessage("Route triggered: " + name);
	      return this.notify(name + ":navigate");
	    };
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18), __webpack_require__(17).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeString = __webpack_require__(20);
	var defaultToWhiteSpace = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Array, Backbone, MixedIn, SinglePageScrollingController, SinglePageScrollingView, _, ltrim, mixins, trim,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	ltrim = __webpack_require__(7);
	
	trim = __webpack_require__(8);
	...
	SinglePageScrollingController = (function(superClass) {
	  ...
	  SinglePageScrollingController.extend = function(obj) {
	    var key, ref, value;
	    for (key in obj) {
	      value = obj[key];
	      this[key] = value;
	  ...
	  SinglePageScrollingController.include = function(obj) {
	    var key, ref, value;
	    for (key in obj) {
	      value = obj[key];
	      this.prototype[key] = value;
	  ...
	  SinglePageScrollingController.prototype.initialize = function(options) {
	    var name, params, ref, ref1, ref2, results, section;
	    ...
	    for (name in ref) {
	      ...
	      this.route(section.route, section.name, this.makeRouteFunction().bind(this, section, name));
	    }
	    ...
	    for (name in ref1) {
	      params = ref1[name];
	      if ((ref2 = params.el) != null ? ref2.length : void 0) {
	        results.push(this.loadSection(params, name));
	      } else {
	        results.push(this._logMessage("Ignoring " + name + " section because no corresponding element exists"));
	      }
	    }
	    return results;
	  };
	  ...
	  SinglePageScrollingController.prototype.navigate = function(route, options) {
	    ...
	    this._logMessage("Navigating to " + route);
	    options = _.extend({}, {
	      trigger: true,
	      scroll: true
	    }, options);
	    ...
	    try {
	      this._logMessage("Trying to get route string from " + section.instance.options.pageName);
	      route = section.instance.getRoute(route);
	      this._logMessage("Got route string from " + section.instance.options.pageName + ": " + route);
	    } catch (_error) {}
	    ...
	    if (options.scroll) {
	      return this.scrollToSection(section.instance.getScrollToElement());
	    }
	  };
	
	  SinglePageScrollingController.prototype.scrollToSection = function(el) {
	    var defaultOptions, options;
	    if (this.scrolling) {
	      return;
	    }
	    this._logMessage('Starting scroll');
	    this.scrolling = true;
	    defaultOptions = {
	      onAfter: this.afterScroll.bind(this)
	    };
	    options = _.extend({}, defaultOptions, this.options.scrollToOptions);
	    return $(window).scrollTo(el, this.options.scrollTime, options);
	  };
	
	  SinglePageScrollingController.prototype.afterScroll = function() {
	    this._logMessage('Ending scroll');
	  ...
	  SinglePageScrollingController.prototype.appLoaded = function(viewName) {
	    ...
	    this._logMessage('App is loaded');
	    this.startHistory();
	  ...
	  SinglePageScrollingController.prototype.loadSection = function(section, name, sections) {
	    ...
	    return view = this.sections[name].instance = new section.view(opts);
	  };
	  ...
	  SinglePageScrollingController.prototype._getResolution = function() {
	    var bp, i, len, ref;
	    ref = this.resolutionBreakPoints;
	    for (i = 0, len = ref.length; i < len; i++) {
	      bp = ref[i];
	      if (window.matchMedia("(min-width: " + bp.min + "px) and (max-width: " + bp.max + "px)").matches) {
	        return bp;
	      }
	    }
	  };
	  ...
	  SinglePageScrollingController.prototype.navigateOnScroll = function(e) {
	    ...
	    this._logMessage("Navigating on scroll");
	    ...
	    try {
	      ...
	      this._logMessage("Got route string from " + section.instance.options.pageName);
	    } catch (_error) {
	      e = _error;
	      route = section.route;
	    }
	  ...
	  SinglePageScrollingController.prototype.startHistory = function(pushState, silent, root) {
	    ...
	    this._logMessage('Starting Backbone.history');
	    ...
	    if (silent !== true) {
	      return this.navigate(window.location.pathname + window.location.search);
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Backbone"] = __webpack_require__(13);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(10), __webpack_require__(14), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=backbone-scrolling-site.js.map