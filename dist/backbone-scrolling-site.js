	  ...
	  SinglePageScrollingView.prototype.initialize = function(options) {
	    ...
	    try {
	      ...
	      return this.notifications.on((
	        ...
	        obj["controller:" + (this.options.pageName != null ? this.options.pageName : 'foo') + ":navigate"] = this.receiveNavigation,
	        obj
	      ), this);
	    } catch (_error) {
	      e = _error;
...
/***/ function(module, exports, __webpack_require__) {
	...
	s.strRightBack     = __webpack_require__(56);
	s.strLeft          = __webpack_require__(59);
	s.strLeftBack      = __webpack_require__(58);
	s.toSentence       = __webpack_require__(61);
	s.toSentenceSerial = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Backbone"] = __webpack_require__(9);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
